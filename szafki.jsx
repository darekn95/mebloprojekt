...
const migrateCab = (rawCab) => {
  ...
  ["cutout", "cutoutR", "obstacle", "backGroove", "plinth", "legs", "gaps", "joints"].forEach((k) => {
...
function computeGeo(cab, mat) {
  ...
  levels.forEach((lv) => {
    ...
    lv.cols.forEach((c, j) => {
      ...
      const cbandH = Math.round(chi - clo);
      ...
      c.rails = rawRails.map((r) => {
        ...
        if (r.orient === "vertical") {
          ...
          return { orient: "vertical", x0: rx, x1: rx + t, y0: lo, y1: lo + rh, z0, zLen: rd, a: rh, b: rd };
        }
