...
const defaultCab = {
  ...
  /* Szafka narozna w L: do korpusu dochodzi ramie wzdluz drugiej sciany, a oba
     ...
     na staly kat 90 stopni, na zawiasach z jednej strony. */
...
const cornerArmParts = (a) => {
  ...
  panels.push({ name: "Front ramienia", qty: 1, a: Math.max(0, len - 2 * luz),
  ...
  const hardware = [{ name: "Zawias", spec: "front ramienia szafki narożnej", qty: 3, unit: "szt." }];
  if (a.doors === "lamane")
