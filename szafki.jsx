...
export default function App() {
  ...
  const assignCabinet = useCallback((i, runId) => setProject((p) => {
    ...
    if (last < 0) return { ...next, active: i };
    const to = last < i ? last + 1 : last;
    const moved = reorderItems({ ...next, active: i }, i, to);
    return moved;
  }), [setProject]);
              ...
              {runInfo && (
                <>
                  ...
                  <Field label="Luz między korpusami"
                    hint="0 przy szafkach skręcanych ze sobą; większy, gdy każda stoi osobno.">
