            ...
            {armsIn(full, n, rysowane).map((a, i) => (
              <g key={"arm" + i} transform={`translate(${a.u0}, 0)`}>
                ...
                {a.doors === "wsporniki" && (() => {
                  ...
                  return (
                    <g>
                      {/* listwa w poprzek ramienia i druga, ktora wchodzi w
                          korpus — razem trzymaja kat prosty */}
                      <rect x={u0} y={yF - CORNER_SUPPORT_W} width={t} height={CORNER_SUPPORT_W + t}
                        fill={a.cab.mat.board.color} stroke={INK} strokeWidth="2" />
                      <rect x={u0} y={yF - CORNER_SUPPORT_W} width={CORNER_SUPPORT_W} height={t}
                        fill={a.cab.mat.board.color} stroke={INK} strokeWidth="2" />
                    </g>
                  );
                })()}
...
const cornerArmParts = (a) => {
  ...
  if (a.doors === "wsporniki") {
    ...
    /* Do wspornika nie domykaja sie same drzwi — na froncie idzie jeszcze waska
       maskownica, ktora zakrywa styk i daje im o co oprzec sie na zamknieciu. */
    panels.push({ name: "Maskownica narożnika", qty: 1, a: CORNER_SUPPORT_W,
      b: d0 ? Math.round(d0.h) : H, matKey: "front",
      edges: { a1: true, a2: true, b1: true, b2: true }, note: "cztery krawędzie" });
  }
